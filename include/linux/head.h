...
#define KERNEL_LINEAR_ADDR_START 0x0000      /* 内核的线性地址空间是从0开始的 */
#define USER_LINEAR_ADDR_LIMIT   0xC0000000  /* 用户的线性地址空间limit=3G开始的 */
#define KERNEL_LINEAR_ADDR_LIMIT 0x40000000  /* 内核的线性地址空间limit=1G开始的 */
